...
export default function Home() {
  ...
  const handleSubmit = async () => {
    try {
        ...
        setShowPopup(false); // Close the popup regardless of the outcome
    }
};
      ...
      <main className="flex flex-1 flex-col bg-white">
        ...
        <div className='w-full flex flex-wrap justify-between'>  
          ...
          <div className='w-full md:w-1/2'>
            <div className="text-center text-gray-800 font-bold text-lg mb-4">Hydration Tracker</div>
          ...
          {/* Weight */}
          <div className='w-full md:w-1/2'>
            <div className="text-center text-gray-700 font-semibold text-lg mb-4">Weight Tracker</div>
            <div className="w-full py-6 bg h-80 bg-pastel-green border-t border-b border-gray-300">
              <div className="flex items-center justify-center space-x-6">
                <Lottie 
          ...
          <div className="my-6 text-center font-semibold text-gray-700 text-lg">Reminders</div>
          ...
          <div className="w-full py-6 bg-pastel-pink border-t border-b border-gray-300">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-4">
                <img src="/undraw_meditation_re_gll0.svg" alt="Meditation Reminder" className="w-28 h-28" />
                <div>
                  <p className="text-lg font-semibold text-gray-700">Daily Meditation</p>
                  <p className="text-sm text-gray-500">Remember to take time to meditate and relax.</p>
                </div>
              </div>
              
              {/* Sleep */}
              <div className="flex items-center space-x-4">
                <img src="/sleep_analysis.svg" alt="Sleep Reminder" className="w-28 h-28" />
                <div>
                  <p className="text-lg font-semibold text-gray-700">Healthy Sleep</p>
                  <p className="text-sm text-gray-500">Ensure you get enough rest every night.</p>
                </div>
              </div>
            </div>
          </div>
